...
admin.site.site_header = "Maps"
admin.site.site_title = "Maps Admin Portal"
admin.site.index_title = "Maps Admin"

# swagger
api_info = openapi.Info(
    title="Maps API",
    default_version="v1",
    description="API documentation for Maps App",
)
